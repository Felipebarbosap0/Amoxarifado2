...
public class DadosUser extends AppCompatActivity {
    Map<String, String> dadosContatosUser; // Declaração de uma variável do tipo Map para armazenar os dados do contato
    ...
    private void mostrarContato() {
        NomeUser.setText(dadosContatosUser.get("Nome")); // Define o nome do contato no TextView correspondente
        IdUser.setText(dadosContatosUser.get("ID")); // Define o ID do contato no TextView correspondente

    }

    private void iniciarComponentes() {
        dadosContatosUser = HomeUser.dadosUser; // Obtém os dados do contato da tela HomeUser
        NomeUser = findViewById(R.id.NomeAdm); // Obtém a referência do TextView para o nome do contato
        IdUser = findViewById(R.id.IdAdm); // Obtém a referência do TextView para o ID do contato
